<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{url('categories')}}"><i class="fa fa-user"></i> User</a></li>
...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
      ...
      {{ Form::open(array('url' => 'users/update/'.$user->idusers, 'class' => 'form-horizontal')) }}
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="email" class="form-control" placeholder="Name" name="email" value="{{$user->email}}" required>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        {{ Form::open(array('url' => 'master/categories/delete/'.$user->id, 'method' => 'delete')) }}
