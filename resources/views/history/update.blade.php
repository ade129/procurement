<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{url('orders')}}"><i class="glyphicon glyphicon-repeat"></i> Detail Order</a></li>
...
<section class="content">
  @php
    if ($order->status == 'a' || $order->status == 'w' || $order->status == 'f' || $order->status == 'h')
      $disabled = 'disabled';
    else
      $disabled = '';  
  @endphp
  ...
  <div class="box">
    ...
    <div class="box-body">
      ...
      {{ Form::open(array('url' => 'history/update/'.$order->idorders, 'class' => 'form-horizontal')) }}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <div class="input-group date">
              ...
              <input type="text" class="form-control datepicker pull-right" id="date" data-date-format='yyyy-mm-dd' value="{{$order->date_orders}}" autocomplete="off" disabled>
            </div>
          </div>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <a href="{{url('history/'.Auth::user()->idusers)}}" class="btn btn-warning pull-right">Back</a>
